...
# Chemin vers le fichier NetCDF
file_path = "/home/onyxia/projet_python_2024_ENSAE/data/tos_Omon_HadGEM3-GC31-LL_ssp126_r1i1p1f3_gn_20150116-20491216.nc"
...
# Enregistrer le graphique
plt.savefig('/home/onyxia/projet_python_2024_ENSAE/output/annual_sst_time_series_scenariossp126.png', dpi=300)

plt.show()

# Sauvegarde des données moyennées annuellement dans un nouveau fichier NetCDF
output_path = "/home/onyxia/projet_python_2024_ENSAE/output/annual_mean_SST_scenariossp126.nc"
tos_annual_mean.to_netcdf(output_path)
